/* jquery.nicescroll 3.5.0 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */(function (e) {
  var z = !1, E = !1, L = 5E3, M = 2E3, y = 0, N = (function () { var e = document.getElementsByTagName('script'), e = e[e.length - 1].src.split('?')[0]; return e.split('/').length > 0 ? e.split('/').slice(0, -1).join('/') + '/' : '' }()), H = ['ms', 'moz', 'webkit', 'o'], v = window.requestAnimationFrame || !1, w = window.cancelAnimationFrame || !1; if (!v) for (var O in H) { var F = H[O]; v || (v = window[F + 'RequestAnimationFrame']); w || (w = window[F + 'CancelAnimationFrame'] || window[F + 'CancelRequestAnimationFrame']) } var A = window.MutationObserver || window.WebKitMutationObserver ||
    !1, I = {zindex: 'auto',
      cursoropacitymin: 0,
      cursoropacitymax: 1,
      cursorcolor: '#424242',
      ...
      rtlmode: !1,
      cursordragontouch: !1,
      oneaxismousemode: 'auto'}, G = !1, P = function () {
      ...
      function k () { var d = b.win; if ('zIndex' in d) return d.zIndex(); for (;d.length > 0 && d[0].nodeType != 9;) { var c = d.css('zIndex'); if (!isNaN(c) && c != 0) return parseInt(c); d = d.parent() } return !1 } function l (d, c, f) { c = d.css(c); d = parseFloat(c); return isNaN(d) ? (d = u[c] || 0, f = d == 3 ? f ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1, b.isie8 && d && (d += 1), f ? d : 0) : d } function q (d, c, f, g) {
        b._bind(d, c, function (b) {
          b = b || window.event; var g = {original: b,
            ...
            stopImmediatePropagation: function () { b.stopImmediatePropagation ? b.stopImmediatePropagation() : b.cancelBubble = !0 }}; c == 'mousewheel' ? (g.deltaY = -0.025 * b.wheelDelta, b.wheelDeltaX && (g.deltaX = -0.025 * b.wheelDeltaX)) : g.deltaY = b.detail; return f.call(d, g)
        }, g)
      } function t (d, c, f) {
        var g, e; d.deltaMode == 0 ? (g = -Math.floor(d.deltaX * (b.opt.mousescrollstep / 54)), e = -Math.floor(d.deltaY *
    (b.opt.mousescrollstep / 54))) : d.deltaMode == 1 && (g = -Math.floor(d.deltaX * b.opt.mousescrollstep), e = -Math.floor(d.deltaY * b.opt.mousescrollstep)); c && (b.opt.oneaxismousemode && g == 0 && e) && (g = e, e = 0); g && (b.scrollmom && b.scrollmom.stop(), b.lastdeltax += g, b.debounced('mousewheelx', function () { var d = b.lastdeltax; b.lastdeltax = 0; b.rail.drag || b.doScrollLeftBy(d) }, 120)); if (e) {
      ...
      } var b = this; this.version = '3.5.0'; this.name = 'nicescroll'; this.me = c; this.opt = {doc: e('body'), win: !1}; e.extend(this.opt, I); this.opt.snapbackspeed = 80; if (h) for (var p in b.opt) typeof h[p] !== 'undefined' && (b.opt[p] = h[p]); this.iddoc = (this.doc = b.opt.doc) && this.doc[0] ? this.doc[0].id || '' : ''; this.ispage = /BODY|HTML/.test(b.opt.win
...
(this.istouchcapable = !0, g.cantouch = !1); g.cantouch && (g.ismozilla && !g.isios && !g.isandroid) && (this.istouchcapable = !0, g.cantouch = !1); b.opt.enablemouselockapi || (g.hasmousecapture = !1, g.haspointerlock = !1); this.delayed = function (d, c, f, g) {
        var e = b.delaylist[d], k = (new Date()).getTime(); if (!g && e && e.tt) return !1; e && e.tt && clearTimeout(e.tt); if (e && e.last + f > k && !e.tt)b.delaylist[d] = {last: k + f, tt: setTimeout(function () { b.delaylist[d].tt = 0; c.call() }, f)}; else if (!e || !e.tt) {
        ...
        this.doc.translate = {x: 0, y: 0, tx: '0px', ty: '0px'}; g.hastranslate3d && g.isios && this.doc.css('-webkit-backface-visibility', 'hidden'); var s = function () {
          var d = b.doc.css(g.trstyle); return d && d.substr(0,
    ...
    l(b.win, 'border-right-width') - b.rail.width : l(b.win, 'border-left-width')), e = b.opt.railoffset; e && (e.top && (f += e.top), b.rail.align && e.left && (g += e.left)); b.locked || b.rail.css({top: f, left: g, height: d ? d.h : b.win.innerHeight()}); b.zoom && b.zoom.css({top: f + 1, left: b.rail.align == 1 ? g - 20 : g + b.rail.width + 4}); b.railh && !b.locked && (f = c.top, g = c.left, d = b.railh.align ? f + l(b.win, 'border-top-width', !0) + b.win.innerHeight() - b.railh.height : f + l(b.win, 'border-top-width', !0), g += l(b.win, 'border-left-width'), b.railh.css({top: d,
            left: g,
            width: b.railh.width}))
        }
    ...
    !g.isieold && !g.isie9mobile) {
          var d = b.docscroll; b.ispage && (d = b.haswrapper ? b.win : b.doc); g.isie9mobile || b.css(d, {'overflow-y': 'hidden'}); b.ispage && g.isie7 && (b.doc[0].nodeName == 'BODY' ? b.css(e('html'), {'overflow-y': 'hidden'}) : b.doc[0].nodeName == 'HTML' && b.css(e('body'), {'overflow-y': 'hidden'})); g.isios && (!b.ispage && !b.haswrapper) && b.css(e('body'), {'-webkit-overflow-scrolling': 'touch'}); var c = e(document.createElement('div')); c.css({position: 'relative',
            top: 0,
            'float': 'right',
            ...
            'border-radius': b.opt.cursorborderradius}); c.hborder = parseFloat(c.outerHeight() - c.innerHeight()); b.cursor = c; var f = e(document.createElement('div')); f.attr('id', b.id); f.addClass('nicescroll-rails'); var l, h, x = ['left', 'right'], q; for (q in x) {
    ...
    0
            ...
            height: 18,
            width: 18,
            backgroundPosition: '0px 0px'}), b.opt.dblclickzoom && b.bind(b.win, 'dblclick', b.doZoom), g.cantouch && b.opt.gesturezoom && (b.ongesturezoom = function (d) { d.scale > 1.5 && b.doZoomIn(d); d.scale < 0.8 && b.doZoomOut(d); return b.cancelEvent(d) }, b.bind(b.win, 'gestureend', b.ongesturezoom))); b.railh = !1; if (b.opt.horizrailenabled) {
            b.css(d, {'overflow-x': 'hidden'}); c = e(document.createElement('div')); c.css({position: 'relative',
              top: 0,
          ...
          }b.ispage ? (f.css({position: 'fixed', top: '0px', height: '100%'}), f.align ? f.css({right: '0px'}) : f.css({left: '0px'}), b.body.append(f), b.railh && (m.css({position: 'fixed', left: '0px', width: '100%'}), m.align ? m.css({bottom: '0px'}) : m.css({top: '0px'}), b.body.append(m))) : (b.ishwscroll ? (b.win.css('position') == 'static' && b.css(b.win, {position: 'relative'}), d = b.win[0].nodeName == 'HTML' ? b.body : b.win, b.zoom && (b.zoom.css({position: 'absolute',
            top: 1,
            right: 0,
            'margin-right': f.width + 4}), d.append(b.zoom)), f.css({position: 'absolute', top: 0}), f.align ? f.css({right: 0}) : f.css({left: 0}), d.append(f), m && (m.css({position: 'absolute', left: 0, bottom: 0}), m.align ? m.css({bottom: 0}) : m.css({top: 0}), d.append(m))) : (b.isfixed = b.win.css('position') == 'fixed', d = b.isfixed ? 'fixed' : 'absolute', b.isfixed || (b.viewport = b.getViewport(b.win[0])), b.viewport && (b.body = b.viewport, !1 == /fixed|relative|absolute/.test(b.viewport.css('position')) && b.css(b.viewport, {position: 'relative'})),
        ...
        (b.autohidedom = !1, b.hide(), b.locked = !1); if (g.isie9mobile) {
            b.scrollmom = new J(b), b.onmangotouch = function (d) {
              d = b.getScrollTop(); var c = b.getScrollLeft(); if (d == b.scrollmom.lastscrolly && c == b.scrollmom.lastscrollx) return !0; var f = d - b.mangotouch.sy, g = c - b.mangotouch.sx; if (Math.round(Math.sqrt(Math.pow(g, 2) + Math.pow(f, 2))) != 0) {
                var n = f < 0 ? -1 : 1, e = g < 0 ? -1 : 1, k = +new Date(); b.mangotouch.lazy && clearTimeout(b.mangotouch.lazy); k - b.mangotouch.tm > 80 || b.mangotouch.dry != n || b.mangotouch.drx != e ? (b.scrollmom.stop(), b.scrollmom.reset(c,
                  d), b.mangotouch.sy = d, b.mangotouch.ly = d, b.mangotouch.sx = c, b.mangotouch.lx = c, b.mangotouch.dry = n, b.mangotouch.drx = e, b.mangotouch.tm = k) : (b.scrollmom.stop(), b.scrollmom.update(b.mangotouch.sx - g, b.mangotouch.sy - f), b.mangotouch.tm = k, f = Math.max(Math.abs(b.mangotouch.ly - d), Math.abs(b.mangotouch.lx - c)), b.mangotouch.ly = d, b.mangotouch.lx = c, f > 2 && (b.mangotouch.lazy = setTimeout(function () { b.mangotouch.lazy = !1; b.mangotouch.dry = 0; b.mangotouch.drx = 0; b.mangotouch.tm = 0; b.scrollmom.doMomentum(30) }, 100)))
              }
            }, f = b.getScrollTop(),
              ...
              b.scrollmom = new J(b); b.ontouchstart = function (d) {
                if (d.pointerType && d.pointerType != 2) return !1; if (!b.locked) {
                  if (g.hasmstouch) {
                    ...
                    b.rail.drag.dl =
    'f'
                  } else { var f = e(window).width(), n = e(window).height(), k = Math.max(document.body.scrollWidth, document.documentElement.scrollWidth), l = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight), n = Math.max(0, l - n), f = Math.max(0, k - f); b.rail.drag.ck = !b.rail.scrollable && b.railh.scrollable ? n > 0 ? 'v' : !1 : b.rail.scrollable && !b.railh.scrollable ? f > 0 ? 'h' : !1 : !1; b.rail.drag.ck || (b.rail.drag.dl = 'f') }b.opt.touchbehavior && (b.isiframe && g.isie) && (f = b.win.position(), b.rail.drag.x += f.left, b.rail.drag.y += f.top)
    ...
    b.onpreventclick); d = e.extend({original: d}, d); 'changedTouches' in d && (d.clientX = d.changedTouches[0].clientX, d.clientY = d.changedTouches[0].clientY); if (b.forcescreen) { var f = d; d = {original: d.original ? d.original : d}; d.clientX = f.screenX; d.clientY = f.screenY }f = ofy = 0; if (t && !c) { var n = b.win.position(), f = -n.left; ofy = -n.top } var k = d.clientY + ofy, n = k - b.rail.drag.y, l = d.clientX + f, h = l - b.rail.drag.x, r = b.rail.drag.st - n; b.ishwscroll && b.opt.bouncescroll ? r < 0 ? r = Math.round(r / 2) : r > b.page.maxh && (r = b.page.maxh + Math.round((r - b.page.maxh) /
    2)) : (r < 0 && (k = r = 0), r > b.page.maxh && (r = b.page.maxh, k = 0)); if (b.railh && b.railh.scrollable) { var m = b.rail.drag.sl - h; b.ishwscroll && b.opt.bouncescroll ? m < 0 ? m = Math.round(m / 2) : m > b.page.maxw && (m = b.page.maxw + Math.round((m - b.page.maxw) / 2)) : (m < 0 && (l = m = 0), m > b.page.maxw && (m = b.page.maxw, l = 0)) }f = !1; if (b.rail.drag.dl)f = !0, b.rail.drag.dl == 'v' ? m = b.rail.drag.sl : b.rail.drag.dl == 'h' && (r = b.rail.drag.st); else {
                    var n = Math.abs(n), h = Math.abs(h), x = b.opt.directionlockdeadzone; if (b.rail.drag.ck == 'v') {
                      if (n > x && h <= 0.3 * n) {
                        return b.rail.drag =
    !1, !0
            ...
            }b.onmousedown = function (d, c) { if (!(b.rail.drag && b.rail.drag.pt != 1)) { if (b.locked) return b.cancelEvent(d); b.cancelScroll(); b.rail.drag = {x: d.clientX, y: d.clientY, sx: b.scroll.x, sy: b.scroll.y, pt: 1, hr: !!c}; var f = b.getTarget(d); !b.ispage && g.hasmousecapture && f.setCapture(); b.isiframe && !g.hasmousecapture && (b.saved.csspointerevents = b.doc.css('pointer-events'), b.css(b.doc, {'pointer-events': 'none'})); return b.cancelEvent(d) } }; b.onmouseup = function (d) {
              if (b.rail.drag &&
    ...
    (d.clientY - b.rail.drag.y), b.scroll.y < 0 && (b.scroll.y = 0), c = b.scrollvaluemax, b.scroll.y > c && (b.scroll.y = c)
              ...
              var p = function (d) {
                if (b.selectiondrag) {
                  if (d) { var c = b.win.outerHeight(); d = d.pageY - b.selectiondrag.top; d > 0 && d < c && (d = 0); d >= c && (d -= c); b.selectiondrag.df = d }b.selectiondrag.df != 0 && (b.doScrollBy(2 *
...
(b.isiframe || b.bind(g.isie && b.ispage ? document : b.win, 'mousewheel', b.onmousewheel), b.bind(b.rail, 'mousewheel', b.onmousewheel), b.railh && b.bind(b.railh, 'mousewheel', b.onmousewheelhr)); !b.ispage && (!g.cantouch && !/HTML|BODY/.test(b.win[0].nodeName)) && (b.win.attr('tabindex') || b.win.attr({tabindex: L++}), b.jqbind(b.win, 'focus', function (d) { z = b.getTarget(d).id || !0; b.hasfocus = !0; b.canshowonmouseevent && b.noticeCursor() }), b.jqbind(b.win, 'blur', function (d) { z = !1; b.hasfocus = !1 }), b.jqbind(b.win, 'mouseenter', function (d) {
    ...
    b.getTarget(d).id || !0; b.hasmousefocus = !0; b.canshowonmouseevent && b.noticeCursor()
            ...
            if (b.locked && b.page.maxh == 0) return !0; d = d || window.e; var c = b.getTarget(d); if (c && /INPUT|TEXTAREA|SELECT|OPTION/.test(c.nodeName) && (!c.getAttribute('type') && !c.type || !/submit|button|cancel/i.tp)) return !0; if (b.hasfocus || b.hasmousefocus && !z || b.ispage && !z && !E) {
...
(b.cursortimeout = setTimeout(function () { if (!b.rail.active || !b.showonmouseevent)b.autohidedom.stop().animate({opacity: b.opt.cursoropacitymin}), b.zoom && b.zoom.stop().animate({opacity: b.opt.cursoropacitymin}), b.cursoractive = !1; b.cursortimeout = 0 }, d || b.opt.hidecursordelay))
    ...
    0 ? (b.hideRail(), b.scrollvaluemax = 0, b.scroll.y = 0, b.scrollratio.y = 0, b.cursorheight = 0, b.setScrollTop(0), b.rail.scrollable = !1) : b.rail.scrollable = !0; b.page.maxw == 0 ? (b.hideRailHr(), b.scrollvaluemaxw = 0, b.scroll.x = 0, b.scrollratio.x = 0, b.cursorwidth = 0, b.setScrollLeft(0), b.railh.scrollable = !1) : b.railh.scrollable = !0; b.locked = b.page.maxh == 0 && b.page.maxw == 0; if (b.locked) return b.ispage || b.updateScrollBar(b.view), !1; !b.hidden && !b.visibility ? b.showRail().showRailHr() : !b.hidden && !b.railh.visibility && b.showRailHr()
      ...
      this.bind = function (d, c, f, e) {
        var k = 'jquery' in d ? d[0] : d; c == 'mousewheel' ? 'onwheel' in b.win ? b._bind(k, 'wheel', f, e || !1) : (d = typeof document.onmousewheel !== 'undefined' ? 'mousewheel' : 'DOMMouseScroll', q(k, d, f, e || !1), d == 'DOMMouseScroll' && q(k, 'MozMousePixelScroll', f, e || !1)) : k.addEventListener ? (g.cantouch && /mouseup|mousedown|mousemove/.test(c) && b._bind(k, c == 'mousedown' ? 'touchstart' : c == 'mouseup' ? 'touchend' : 'touchmove', function (b) {
          if (b.touches) {
        ...
        }, e || !1), b._bind(k, c, f, e || !1), g.cantouch && c == 'mouseup' && b._bind(k, 'touchcancel', f, e || !1)) : b._bind(k, c, function (d) { if ((d = d || window.event || !1) && d.srcElement)d.target = d.srcElement; 'pageY' in d || (d.pageX = d.clientX + document.documentElement.scrollLeft, d.pageY = d.clientY + document.documentElement.scrollTop); return !1 === f.call(k, d) || !1 === e ? b.cancelEvent(d) : !0 })
    ...
    b.win[0].detachEvent('onpropertychange', b.onAttributeChange); !1 !== b.observer && b.observer.disconnect(); !1 !== b.observerremover && b.observerremover.disconnect(); b.events = null; b.cursor && b.cursor.remove(); b.cursorh && b.cursorh.remove(); b.rail && b.rail.remove(); b.railh && b.railh.remove(); b.zoom && b.zoom.remove(); for (var d = 0; d < b.saved.css.length; d++) { var c = b.saved.css[d]; c[0].css(c[1], typeof c[2] === 'undefined' ? '' : c[2]) }b.saved = !1; b.me.data('__nicescroll', ''); var f = e.nicescroll; f.each(function (d) {
          if (this && this.id ===
        ...
        for (;b && b.nodeType == 1 && !/BODY|HTML/.test(b.nodeName);) { var c = e(b), c = c.css('overflowY') || c.css('overflowX') || c.css('overflow') || ''; if (/scroll|auto/.test(c)) return b.clientHeight != b.scrollHeight; b = b.parentNode ? b.parentNode : !1 } return !1
    ...
    (b.nativescrollingarea = b.isScrollable(d), f = !0); b.checkarea = c; if (b.nativescrollingarea) return !0; if (d = t(d, !1, f))b.checkarea = 0; return d
      ...
      }; this.getTransitionSpeed = function (d) { var c = Math.round(10 * b.opt.scrollspeed); d = Math.min(c, Math.round(d / 20 * b.opt.scrollspeed)); return d > 20 ? d : 0 }; b.opt.smoothscroll ? b.ishwscroll && g.hastransition && b.opt.usetransition ? (this.prepareTransition = function (d, c) {
        var f = c ? d > 20 ? d : 0 : b.getTransitionSpeed(d), e = f ? g.prefixstyle + 'transform ' + f + 'ms ease-out' : ''; if (!b.lasttransitionstyle || b.lasttransitionstyle != e) {
        ...
        e, b.doc.css(g.transitionstyle, e)
          ...
          var k = b.getScrollTop(), l = b.getScrollLeft(); ((b.newscrolly - k) * (e - k) < 0 || (b.newscrollx - l) * (c - l) < 0) && b.cancelScroll(); !1 == b.opt.bouncescroll && (e < 0 ? e = 0 : e > b.page.maxh && (e = b.page.maxh), c < 0 ? c = 0 : c > b.page.maxw && (c = b.page.maxw))
    ...
    b.setScrollLeft(e); b.noticeCursor(!1, c, e); b.cursorfreezed = !1; c < 0 ? c = 0 : c > b.page.maxh && (c = b.page.maxh); e < 0 ? e = 0 : e > b.page.maxw && (e = b.page.maxw); if (c != b.newscrolly || e != b.newscrollx) return b.doScrollPos(e, c, b.opt.snapbackspeed); b.onscrollend && b.scrollrunning && b.onscrollend.call(b, {type: 'scrollend', current: {x: e, y: c}, end: {x: b.newscrollx, y: b.newscrolly}}); b.scrollrunning = !1
        ...
        g) { var f = b.scrollrunning ? b.newscrollx : b.getScrollLeft(); b.doScrollPos(f, c, g) }, this.doScrollPos = function (c, g, f) {
          function e () {
            if (b.cancelAnimationFrame) return !0; b.scrollrunning = !0; if (p = 1 - p) return b.timer = v(e) || 1; var c = 0, d = sy = b.getScrollTop(); if (b.dst.ay) { var d = b.bzscroll ? b.dst.py + b.bzscroll.getNow() * b.dst.ay : b.newscrolly, f = d - sy; if (f < 0 && d < b.newscrolly || f > 0 && d > b.newscrolly)d = b.newscrolly; b.setScrollTop(d); d == b.newscrolly && (c = 1) } else c = 1; var g = sx = b.getScrollLeft(); if (b.dst.ax) {
        ...
        var f = b.getScrollLeft(); b.doScrollPos(f,
          c, g)
      }, this.doScrollPos = function (c, g, f) { var e = c > b.page.maxw ? b.page.maxw : c; e < 0 && (e = 0); var k = g > b.page.maxh ? b.page.maxh : g; k < 0 && (k = 0); b.synched('scroll', function () { b.setScrollTop(k); b.setScrollLeft(e) }) }, this.cancelScroll = function () {}); this.doScrollBy = function (c, g) {
        var f = 0, f = g ? Math.floor((b.scroll.y - c) * b.scrollratio.y) : (b.timer ? b.newscrolly : b.getScrollTop(!0)) - c; if (b.bouncescroll) { var e = Math.round(b.view.h / 2); f < -e ? f = -e : f > b.page.maxh + e && (f = b.page.maxh + e) }b.cursorfreezed = !1; py = b.getScrollTop(!0); if (f < 0 &&
        py <= 0) return b.noticeCursor(); if (f > b.page.maxh && py >= b.page.maxh) return b.checkContentSize(), b.noticeCursor(); b.doScrollTop(f)
      }; this.doScrollLeftBy = function (c, g) { var f = 0, f = g ? Math.floor((b.scroll.x - c) * b.scrollratio.x) : (b.timer ? b.newscrollx : b.getScrollLeft(!0)) - c; if (b.bouncescroll) { var e = Math.round(b.view.w / 2); f < -e ? f = -e : f > b.page.maxw + e && (f = b.page.maxw + e) }b.cursorfreezed = !1; px = b.getScrollLeft(!0); if (f < 0 && px <= 0 || f > b.page.maxw && px >= b.page.maxw) return b.noticeCursor(); b.doScrollLeft(f) }; this.doScrollTo =
        ...
        if (!b.zoomactive) {
          b.zoomactive =
        !0; b.zoomrestore = {style: {}}; var k = 'position top left zIndex backgroundColor marginTop marginBottom marginLeft marginRight'.split(' '), f = b.win[0].style, l; for (l in k) { var h = k[l]; b.zoomrestore.style[h] = typeof f[h] !== 'undefined' ? f[h] : '' }b.zoomrestore.style.width = b.win.css('width'); b.zoomrestore.style.height = b.win.css('height'); b.zoomrestore.padding = {w: b.win.outerWidth() - b.win.width(), h: b.win.outerHeight() - b.win.height()}; g.isios4 && (b.zoomrestore.scrollTop = e(window).scrollTop(), e(window).scrollTop(0))
    ...
    -1
      }; this.update = function (e, l) { var h = c.time(); c.steptime = h - c.lasttime; c.lasttime = h; var h = l - c.lasty, t = e - c.lastx, b = c.nc.getScrollTop(), p = c.nc.getScrollLeft(), b = b + h, p = p + t; c.snapx = p < 0 || p > c.nc.page.maxw; c.snapy = b < 0 || b > c.nc.page.maxh; c.speedx = t; c.speedy = h; c.lastx = e; c.lasty = l }; this.stop = function () { c.nc.unsynched('domomentum2d'); c.timer && clearTimeout(c.timer); c.timer = 0; c.lastscrollx = -1; c.lastscrolly = -1 }; this.doSnapy = function (e, l) {
        var h = !1; l < 0 ? (l = 0, h = !0) : l > c.nc.page.maxh && (l = c.nc.page.maxh, h = !0); e < 0 ? (e = 0, h =
    !0) : e > c.nc.page.maxw && (e = c.nc.page.maxw, h = !0); h && c.nc.doScrollPos(e, l, c.nc.opt.snapbackspeed)
      }; this.doMomentum = function (e) {
        var l = c.time(), h = e ? l + e : c.lasttime; e = c.nc.getScrollLeft(); var t = c.nc.getScrollTop(), b = c.nc.page.maxh, p = c.nc.page.maxw; c.speedx = p > 0 ? Math.min(60, c.speedx) : 0; c.speedy = b > 0 ? Math.min(60, c.speedy) : 0; h = h && l - h <= 60; if (t < 0 || t > b || e < 0 || e > p)h = !1; e = c.speedx && h ? c.speedx : !1; if (c.speedy && h && c.speedy || e) {
          var g = Math.max(16, c.steptime); g > 50 && (e = g / 50, c.speedx *= e, c.speedy *= e, g = 50); c.demulxy = 0; c.lastscrollx =
    c.nc.getScrollLeft(); c.chkx = c.lastscrollx; c.lastscrolly = c.nc.getScrollTop(); c.chky = c.lastscrolly; var s = c.lastscrollx, u = c.lastscrolly, d = function () {
            var e = c.time() - l > 600 ? 0.04 : 0.02; if (c.speedx && (s = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)), c.lastscrollx = s, s < 0 || s > p))e = 0.1; if (c.speedy && (u = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)), c.lastscrolly = u, u < 0 || u > b))e = 0.1; c.demulxy = Math.min(1, c.demulxy + e); c.nc.synched('domomentum2d', function () {
    ...
    }, B = e.fn.scrollTop; e.cssHooks.pageYOffset = {get: function (h, c, k) { return (c = e.data(h, '__nicescroll') || !1) && c.ishwscroll ? c.getScrollTop() : B.call(h) },
    set: function (h, c) {
      var k = e.data(h, '__nicescroll') || !1; k && k.ishwscroll
        ? k.setScrollTop(parseInt(c)) : B.call(h, c); return this
    }}; e.fn.scrollTop = function (h) { if (typeof h === 'undefined') { var c = this[0] ? e.data(this[0], '__nicescroll') || !1 : !1; return c && c.ishwscroll ? c.getScrollTop() : B.call(this) } return this.each(function () { var c = e.data(this, '__nicescroll') || !1; c && c.ishwscroll ? c.setScrollTop(parseInt(h)) : B.call(e(this), h) }) }; var C = e.fn.scrollLeft; e.cssHooks.pageXOffset = {get: function (h, c, k) { return (c = e.data(h, '__nicescroll') || !1) && c.ishwscroll ? c.getScrollLeft() : C.call(h) },
    set: function (h,
      c) { var k = e.data(h, '__nicescroll') || !1; k && k.ishwscroll ? k.setScrollLeft(parseInt(c)) : C.call(h, c); return this }}; e.fn.scrollLeft = function (h) { if (typeof h === 'undefined') { var c = this[0] ? e.data(this[0], '__nicescroll') || !1 : !1; return c && c.ishwscroll ? c.getScrollLeft() : C.call(this) } return this.each(function () { var c = e.data(this, '__nicescroll') || !1; c && c.ishwscroll ? c.setScrollLeft(parseInt(h)) : C.call(e(this), h) }) }; var D = function (h) {
    ...
    typeof c === 'undefined' && (typeof h === 'object' && !('jquery' in h)) && (c = h, h = !1); var k = new D(); typeof c === 'undefined' && (c = {}); h && (c.doc = e(h), c.win = e(this)); var l = !('doc' in c); !l && !('win' in c) && (c.win = e(this)); this.each(function () {
